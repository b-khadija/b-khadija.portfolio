...
const Home = () => {
  return (
    <div className="flex justify-center items-center flex-col min-h-screen text-white relative z-0">
      <motion.div
        initial={{ scale: 1 }}
      ...
      >
        ...
        <div className="flex flex-col sm:flex-row justify-evenly pt-3 text-lg sm:text-3xl tracking-wider space-y-4 sm:space-y-0 sm:space-x-4 items-center">
          <div className="flex items-center group">
            <HiOutlineArrowRight className="transition-transform transform group-hover:rotate-45 duration-200 group-hover:text-DarkCyan" />
            <Link
              to="./Project.js"
              className="cursor-none pl-2 group-hover:underline group-hover:underline-offset-4 group-hover:text-DarkCyan group-hover:font-semibold"
            >
              Voir mes projets
            </Link>
          </div>
